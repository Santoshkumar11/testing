...
if($event=="home")
	...
	elseif($event=="mouseve")
	{
	include("mouse_event.php");
	}
	elseif($event=="ent")
	{
	include("enter.php");
	}
	elseif($event=="tab_order")
	{
	include("tab.php");
	}
	?>
...
<a href="welcome.php?event=mouseve" id="mouseve">Java Script mouse events</a><br/>
<a href="welcome.php?event=ent" id="ent">Java Script enter events</a><br/>
<a href="welcome.php?event=tab_order" id="tab_order">Java Script tab order events</a><br/>
</div>
